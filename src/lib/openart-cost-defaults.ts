...
export const OPENART_COST_DEFAULTS: CostCacheItem[] = [
  ...
  // Seedance / Veronix — model clip lengths (free trial uses stock intro + 4s model)
  ...
  { model: "byte-plus-seedance-2-mini", mode: "text2video", totalCredits: 360, unitCredits: 360, config: { videoCount: 1, resolution: "720p", duration: 9, aspectRatio: "16:9", generateAudio: true }, mediaType: "video" },
  ...
  { model: "byte-plus-seedance-2-mini", mode: "image2video", totalCredits: 360, unitCredits: 360, config: { videoCount: 1, resolution: "720p", duration: 9, aspectRatio: "16:9", generateAudio: true }, mediaType: "video" },
  ...
  { model: "byte-plus-seedance-2-mini", mode: "element2video", totalCredits: 360, unitCredits: 360, config: { videoCount: 1, resolution: "720p", duration: 9, aspectRatio: "16:9", generateAudio: true }, mediaType: "video" },
