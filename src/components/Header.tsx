    ...
    <header className="relative z-20 border-b border-white/8 bg-[rgba(10,12,16,0.72)] backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <div className="flex items-center gap-3">
          <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-[var(--neon-cyan)] to-[var(--accent)] shadow-[0_0_32px_rgba(34,240,255,0.35)]">
            <Sparkles className="h-5 w-5 text-[#06141a]" strokeWidth={2.25} />
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-sm text-white/85">
            <Coins className="h-4 w-4 text-[var(--neon-cyan)]" />
