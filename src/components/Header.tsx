      ...
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group inline-flex items-center gap-2 rounded-full bg-[var(--neon-cyan)] px-3 py-2 text-sm font-semibold text-[#041016] transition duration-300 hover:bg-[var(--neon-cyan-strong)] sm:px-4"
          >
